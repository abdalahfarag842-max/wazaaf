...
<div class="show-grid">
    ...
    <div class="detail-card">
        ...
        <div class="detail-row">
            <span class="detail-label"><i class="ti ti-building"></i> Company</span>
        ...
        @if($job->company)
            @if($job->company->email)
                <div class="detail-row">
                    <span class="detail-label"><i class="ti ti-mail"></i> Company Email</span>
                    <span class="detail-value">{{ $job->company->email }}</span>
                </div>
            @endif

            @if($job->company->website)
                <div class="detail-row">
                    <span class="detail-label"><i class="ti ti-world"></i> Website</span>
    ...
    <div class="detail-card">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
            <h2 class="detail-section-title" style="margin:0">
                Applications
                <span class="apps-chip" style="margin-left:8px">

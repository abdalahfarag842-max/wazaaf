...
<nav class="navbar-custom">
    ...
    <div class="nav-links">
        ...
        <a href="{{ route('jobs.index') }}" class="active">Browse Jobs</a>
...
<div class="browse-layout">
    ...
    <div class="sidebar">
        <form action="{{ route('jobs.index') }}" method="GET" id="filterForm">
            ...
            <a href="{{ route('jobs.index') }}" class="btn-clear-filter">Clear All</a>
    ...
    <div class="main-content">
        ...
        @if($jobs->count())
            @foreach($jobs as $i => $job)
                ...
                @endphp
                <a href="{{ route('jobs.show', $job) }}" class="job-card {{ $isClosed ? 'closed' : '' }}">
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ route('jobs.index') }}" style="color:#1a56db;font-size:14px;margin-top:8px;display:inline-block;">Clear filters</a>
            </div>
        @endif
    </div>
</div>

...
<div class="page-wrapper">
    <a href="{{ route('candidate.jobs.index') }}" class="back-link">
    ...
    <div class="actions-card">
        ...
        @else
            <a href="{{ route('candidate.applications.create', ['job_id' => $job->id]) }}" class="btn-apply">
                <i class="fas fa-paper-plane"></i> Apply for this Job
            </a>
        @endif

        <a href="{{ route('candidate.home') }}" class="btn-back">
